...
namespace Contact.API.FunctionalTests.ApiEndpoints
{
    ...
    public class DeleteContactDetailEndpointTests(CustomWebApplicationFactory<Contact.API.Program> factory) : IClassFixture<CustomWebApplicationFactory<Contact.API.Program>>
    {
